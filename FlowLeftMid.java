...
public class FlowLeftMid extends TypedAtomicActor {
	...
	//------------------------------------
	public FlowLeftMid(CompositeEntity container, String name) throws               
	    ...
	    StringAttribute _injectCardinal = new StringAttribute(_injectport,
                "_cardinal");
	    _injectCardinal.setExpression("WEST");
	    StringAttribute _inject2Cardinal = new StringAttribute(_injectcredits,
                "_cardinal");
	    _inject2Cardinal.setExpression("WEST");
        /*--------------------------------------------------------------*/
...
//----------------------------CHECK SOUTH PORT---------------------------//
	...
	public void outselect() throws IllegalActionException {
								//	 direction = 0, direction = 1, direction = 2,  direction = 4;
								// { {S,E,N,I},{S,E,N,I}, {S,E,N,I}, {S,E,N,I} } 
